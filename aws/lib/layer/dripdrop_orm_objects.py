...
class Post(Base):
    ...
    images = relationship("Image", order_by="Image.imageID", back_populates="postRel", cascade="all, delete-orphan")
...
# Tag tablefrom sqlalchemy import Column, Integer, String, ForeignKey, Date, Float, Boolean, Index
from sqlalchemy.orm import relationship, validates
from sqlalchemy.ext.declarative import declarative_base
